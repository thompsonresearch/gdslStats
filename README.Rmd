...
This forked Repository is an updated version of the package created by Dr Paul Williamson for the University of Liverpool's introductory statistic courses ENVS450 and ENVS451. The additional functions included here were all produced by Dr Williamson, and are only made available through this account for ease of access for students.
...
You can install the most recent development version of gdslStats from [GitHub](https://github.com/) with:
